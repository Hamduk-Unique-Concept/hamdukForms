    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link href={`/dashboard/forms/${form.id}/tickets`}>
            <Button className="w-full" variant="outline">
              Tickets
            </Button>
          </Link>

          <Link href={`/dashboard/forms/${form.id}/waitlist`}>
            <Button className="w-full" variant="outline">
              Waitlist
            </Button>
          </Link>

          <Link href={`/dashboard/forms/${form.id}/revenue`}>
            <Button className="w-full" variant="outline">
              Revenue
            </Button>
          </Link>

          <Link href={`/dashboard/forms/${form.id}/refunds`}>
            <Button className="w-full" variant="outline">
              Refunds
            </Button>
          </Link>
