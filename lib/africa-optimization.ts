...
export function getRegionalPaymentMethods(countryCode: string): string[] {
  const paymentMap: Record<string, string[]> = {
    'NG': ['Paystack', 'Flutterwave', 'Bank Transfer'],
    'KE': ['M-Pesa', 'Stripe', 'Paystack'],
    'GH': ['Paystack', 'Flutterwave', 'Bank Transfer'],
    'ZA': ['Stripe', 'PayFast', 'Bank Transfer'],
    'EG': ['Stripe', 'Fawry', 'Bank Transfer'],
  };
  
  return paymentMap[countryCode] || ['Stripe', 'Paystack', 'Bank Transfer'];
}
